            ...
            <div class="modal-body p-0">
                <div class="container-fluid">
                    ...
                    <div class="gap-2 d-flex flex-column">
                        ...
                        <input type="text" id="edit-name" class="form-control" placeholder="nama" value="{{ $user->name }}" required>
                        <label for="edit-nickname">Nickname <span class="text-danger form-label">*</span></label>
                        <input type="text" id="edit-nickname" class="form-control" placeholder="nickname" value="{{ $user->nickname }}" required>
                        <label for="edit-email">Email <span class="text-danger">*</span></label>
                        <input type="email" id="edit-email" class="form-control" placeholder="email" value="{{ $user->email }}" required>
                        <label for="edit-phone">Phone <span class="text-danger">*</span></label>
                        <input type="number" id="edit-phone" class="form-control" placeholder="phone" value="{{ $user->phone }}" required>
